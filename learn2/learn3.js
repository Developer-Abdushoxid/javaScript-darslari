...
//     const resultScore = score.map((baho, index) =>
//       index === 0 ? 100 : (((baho - score[index - 1]) / score[index - 1]) * 100).toFixed(1)
//     );
  
//     console.log(`Shaxs: ${name}`);
//     console.log(`Foiz o'zgarishlar: ${resultScore.join('%, ')}`);
//   });
  ...
  students.forEach(({name, score}) => {
    ...
    console.log(`Foiz ozgaruvchi ${result.join(',% ')}`)
  })
